...
function [HE_OH, C0, phi, V, payoff, Sgrid,C,a,rho] = Hedging_Error_Gaussian(S,T,K,r,mu,sigma,put,minS,maxS,m,max_phi)
     ...
     [Sgrid,C,a,~,rho,~] = HedgingGaussian(mu,sigma,T,K,r,n,put,minS,maxS,S0,m);
