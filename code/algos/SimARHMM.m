function [x,reg] = SimARHMM(mu,phi,sigma,Q,eta0,n)
%
% Generates a regime-switching autoregressive (p=1) Gaussian random walk
% regimes starting  from a given state eta0.
% 
% Input
%        mu: mean of each regime;
%        phi   : autoregressive coefficient of each regime;
