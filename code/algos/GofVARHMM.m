function out = GofVARHMM(R,reg,max_iter, prec,n_sample)
%
...
[mu,phi,A,Q,nu,eta,cvm_est] = EstVARHMM(R,reg,max_iter, prec);
...
parfor i = 1:n_sample
        ...
        R1 = SimVARHMM(mu,phi,A,Q,eta0(i),n);
        [~,~,~,~,~,~,cvm_sim(i)] = EstVARHMM(R1,reg,max_iter, prec);
