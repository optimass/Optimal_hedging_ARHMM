function out = GofHMMd(R,reg,max_iter, prec,n_sample)
%
...
%
%     By Bruno Remillard, Apr 10, 2013


%[mu,A,Q,eta,nu] = EstHMMd(R,reg,max_iter, prec);
[mu,A,Q,nu,eta,cvm_est] = EstHMMd_mex(R,reg,max_iter, prec);

fprintf('\n End of estimation\n'); 

[n,p] = size(R) ; % #of obs and dimensions
...
parfor i=1:n_sample
    ...
    R1 = SimHMMd(mu,A,Q,eta0(i),n);
    
    [mu1,A1,Q1,~,eta1,cvm_sim(i)] = EstHMMd_mex(R1,reg,max_iter, prec);
