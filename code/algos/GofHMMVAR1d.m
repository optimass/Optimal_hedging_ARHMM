function out =  GofHMMVAR1d(R,reg,max_iter,prec,N)
%
...
[mu,phi,sigma,Q,nu,eta] = EstHMMVAR1d_mex(R,reg,max_iter,eps);
...
parfor i=1:N
    i
    R1 = SimHMMVAR1d(mu,phi,sigma,Q,reg,n);
    
   [mu1,phi1,sigma1,Q1,~,eta1] = EstHMMVAR1d_mex(R1,reg,max_iter,prec);
